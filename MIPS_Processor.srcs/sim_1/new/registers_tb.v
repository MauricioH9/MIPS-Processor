...
module registers_tb;
    ...
    initial begin
        ...
        // Test Case 1: Assert reset and verify all registers are cleared
        #10;                 // Wait for reset 
        reset = 0;          
        rs = 5'b00001;       // Read register 1
        rt = 5'b00010;       // Read register 2
        #10;
        $display("TC1: Reset Asserted | rs=%d | rt=%d | read_data_rs=%h | read_data_rt=%h",
        ...
        // Test Case 6: Reassert reset and verify registers are cleared
        reset = 1;
        #10;
        rs = 5'b00010; // Read from register 2
        rt = 5'b00001; // Read from register 1
        #10;
        $display("TC6: Reset Reasserted | rs=%d | rt=%d | read_data_rs=%h | read_data_rt=%h",
                 rs, rt, read_data_rs, read_data_rt);
